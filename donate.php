...
if(isset($_POST['submit'])){
	if(isset($_POST['term']) === true){
		...
		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
			...
			isset($contact) && isset($city) && isset($password) ){
				...
				$sql = " INSERT INTO donor ( namee, gender, email, city, dob, contact_no, save_life_date, pass, blood_group) VALUES('$name' , '$gender' , '$email' , '$city' , '$DonorDOB' , '$contact' , '0' , '$password' , '$blood_group') ";
		...
		//   </div>'; 
			...
			<strong>Data not Inserted Sucessfully, Try Again. </strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>'; 
...
<div class="container-fluid bg-dark size">
	<div class="row">
		<div class="col-md-6 offset-md-3">
			<h1 class="text-center">First create your Account.</h1>
			<hr class="white-bar">
		</div>
	</div>
</div>
