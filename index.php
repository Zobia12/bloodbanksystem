...
<div class="container-fluid header-img">
				<div class="row">
					<div class="col-md-6 offset-md-3">
						...
						<div class="header">
						<h1 class="text-center text-dark ">WELCOME TO THE BLOOD BANK!</h1>
						<hr class="white-bar">
						<br><br><br>

						<h2 class="text-center">YOU CAN SAVE THE POORS LIFE, DONATE AND GET BLESSINGS.</b> </h2>
						<br>
						<h6 class="text-center">Blood is the most precious gift that anyone can give to another person.</h6>
						<h6 class="text-center">Donating blood not saves the life also save the donor's Life</h6>
			...
			<!-- header ends -->
				<div class="row">
					<div class="col-md-6 offset-md-3">
						...
						<div class="header">
			<h2 class="text-center">Search For Donors</h2>
