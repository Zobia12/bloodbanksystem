...
if(isset($_POST['submitt'])){
		...
		<strong>Only lower, upper case and space characters are allow. </strong>
...
//contact error
			...
			<strong>Please enter valid your number. </strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>'; 
		...
		//email error
			...
			<strong>Please enter valid your email. </strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>'; 
			...
			isset($contact) && isset($city)  ){

                $DonorDOB = $year . "-" . $month. "-" . $day;  

				$sql = " UPDATE donor SET namee =' $name', gender= '$gender', email = '$email', city= '$city', dob = '$DonorDOB', contact_no = '$contact', blood_group = '$blood_group' 
			...
			if(mysqli_query( $connection, $sql)){
				...
				$updateSucess = '<div class="alert alert-success alert-dismissible fade show" role="alert">
				...
				$updateEror = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
			...
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				 ...
				 && !empty($_POST['c_password']) && isset($_POST['new_password']) && !empty($_POST['new_password'])){
					...
					if($oldpass==$dbpassword){
						...
						if(strlen($_POST['new_password'])>=6){
						   ...
						   $passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
						   <strong>Password entered should consist of 6 letters. </strong>
						   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
							 <span aria-hidden="true">&times;</span>
						   </button>
						 </div>';
			  ...
			  if(isset($password)){
				...
				if(mysqli_query($connection, $sql)){
					$updatepassSucess = '<div class="alert alert-success alert-dismissible fade show" role="alert">
				   ...
				   <?php
					...
					$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
					<strong>Password not updated. TRY AGAIN. </strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					  <span aria-hidden="true">&times;</span>
					</button>
				  </div>'; 
...
<style>
		...
		padding: 20px 10px 20px 30px; 
			...
			<div class="row">
				...
				<div class=" card col-md-6 offset-md-3">
					...
					<?php if(isset($updateSucess)) echo $updateSucess ; 

				     if(isset($updateEror )) echo $updateEror; ?>
			  ...
			  <?php if(isset($blood_groupError)) echo $blood_groupError; ?>
					...
					<div class="form-group">
				              <label for="gender">Gender</label><br>
				              		Male<input type="radio" name="gender" id="gendermale" value="Male" style="margin-left:10px; margin-right:10px;" checked>
				              		Female<input type="radio" name="gender" id="genderfemale" value="Female" style="margin-left:10px;" <?php  if(isset($gender)){ 
			...
			<?php if(isset($yearError)) echo $yearError; ?>
              ...
              <input type="text" name="contact_no"  placeholder="03********" 
			   value="<?php if(isset($contact)) echo $contact; ?>" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11">
	...
	<optgroup title="Azad Jammu and Kashmir (Azad Kashmir)" label="&raquo; Azad Jammu and Kashmir (Azad Kashmir)">
            ...
            <br>
					...
					<div class="form-group">
						<button id="submit" name="submitt" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">UPDATE</button>
					</div>
				</form>
					</div>
				</div>
				...
				<div class="card col-md-6 offset-md-3">
					...
					<?php  if(isset($passwordError)) echo $passwordError ; 
						 if(isset($updatepassSucess)) echo $updatepassSucess;?>	
					...
					<div class="panel panel-default" style="padding: 20px;">
						<form action="" method="post" class="form-group form-container" >
			               ...
			               <div class="form-group">
			                  	<button id="submitpass" name="update_pass" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">UPDATE PASSWORD</button>
			              </div>
