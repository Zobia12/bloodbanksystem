...
<?php 
	...
	if(isset($_POST['date'])){
		...
		<strong>ARE YOU SURE FOR DONATING YOUR BLOOD?</strong>
	...
	if(isset($_POST['userid'])){
		...
		$sql = "UPDATE donor SET save_life_date ='$cdate' WHERE id='$userid' ";

		if(mysqli_query($connection, $sql)){
        

			$_SESSION['save_life_date']=$cdate;
			...
			<div class="row">
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						...
						<?php  if(isset($submitError)) echo $submitError;?>
							...
							<div class="heading text-center">
								<h2>Welcome </h2> <h1> <?php if(isset($_SESSION['namee'] )) echo $_SESSION['namee']; ?></h1>
							</div>
							...
							$savedate = $_SESSION['save_life_date'];
                                if($savedate=='0'){
									...
									<button style="margin-top: 20px;" type="submit" name="date" id="save_the_life" class="btn btn-lg btn-danger center-aligned ">
					...
					if($diffMonth>=3){
						...
						echo '<form target="" method="post">
						<button style="margin-top: 20px;" type="submit" name="date" id="save_the_life" 
						...
						<center><span class="name">Congratulations!!
									</span> <span> <br> You have denoted the blood. 
								 You can denote the blood after 3 months. Thankyou!</span></center> </div>
